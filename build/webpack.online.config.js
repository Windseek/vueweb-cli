...
const HtmlWebpackPlugin = require('html-webpack-plugin');//打包html模版到dist_online文件夹下面
...
module.exports = {
  ...
  output: {
    path: path.resolve(__dirname, '../dist_online'),
  ...
  plugins: [
    ...
    new CleanWebpackPlugin(['./*'],{
      root: path.resolve(__dirname, '../dist_online'),
      verbose: true,
      dry: false
    }),//在打包前，删掉dist_online下面的文件
    ...
    new CopyWebpackPlugin([{
      from: __dirname + '/../static/onlineconfig',
      to:__dirname + '/../dist_online/config'
    }])
  ],
  resolve: {
    alias: {
