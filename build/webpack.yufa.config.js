...
const HtmlWebpackPlugin = require('html-webpack-plugin');//打包html模版到dist_yufa文件夹下面
...
module.exports = {
  ...
  output: {
    path: path.resolve(__dirname, '../dist_yufa'),
  ...
  plugins: [
    ...
    new CleanWebpackPlugin(['./*'],{
      root: path.resolve(__dirname, '../dist_yufa'),
      verbose: true,
      dry: false
    }),//在打包前，删掉dist_yufa下面的文件
    ...
    new CopyWebpackPlugin([{
      from: __dirname + '/../static/yufaconfig',
      to:__dirname + '/../dist_yufa/config'
    }])
  ],
  resolve: {
    alias: {
